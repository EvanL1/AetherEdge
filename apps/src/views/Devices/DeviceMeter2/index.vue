...
// onMounted(async () => {
//   try {
//     const res = await getPointsTables(7)
...
//       const channel7TUpdate = data.updates?.find(
//         (item: any) => item.channel_id === 7 && item.data_type === 'T',
//       )
//       if (channel7TUpdate) {
//         const values = channel7TUpdate.values || {}
//         const timestamps = channel7TUpdate.ts || {}
...
//         })
//       }
//       const channel7SUpdate = data.updates?.find(
//         (item: any) => item.channel_id === 7 && item.data_type === 'S',
//       )
//       if (channel7SUpdate) {
//         const values = channel7SUpdate.values || {}
//         const timestamps = channel7SUpdate.ts || {}

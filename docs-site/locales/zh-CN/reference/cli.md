...
请参阅 [AI Assistants](/guides/ai-assistants) 以连接 MCP 客户端。
...
- **Exit 2** — 命令行使用错误（未知子命令或标志）； clap 将错误和使用提示打印到 stderr。
...
- [AI Assistants](/guides/ai-assistants) — 从 AI 驱动 CLI 和 MCP 服务器agent

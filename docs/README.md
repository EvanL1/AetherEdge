...
完成独立发行。`aether-edge-sdk` 是唯一受支持的公开 Rust API；架构边界、依赖方向与
数据权威规则见仓库根目录的 [AGENTS.md](../AGENTS.md) 与
...
- [协议适配器参考](./reference/protocol-adapters.md) — Feature、Runtime ID、配置、映射与实现边界

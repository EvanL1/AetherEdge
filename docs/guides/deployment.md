...
| `/etc/aether/aether.env` | Explicit config/data/database paths, optional IO channel-diagnostic `AETHER_LOG_DIR`, process `RUST_LOG`, and freshly generated secrets (mode 600) |

...
| `SHM_TOPOLOGY_REFRESH_INTERVAL_MS` | `1000` (minimum `100`) | Interval used by alarm and automation to reload one SQLite topology snapshot and atomically publish a validated point/health/routing generation |

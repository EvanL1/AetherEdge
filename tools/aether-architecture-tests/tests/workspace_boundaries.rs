...
const RETIRED_ROOT_PATHS: &[&str] = &[
    ...
    "libs/aether-store-local/src/integration_generation.rs",
    ...
    "services/io/src/protocols/gateway/address.rs",
    "services/io/src/protocols/gateway/config.rs",
    "services/io/src/protocols/gateway/factory.rs",

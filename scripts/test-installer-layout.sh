...
assert_not_contains "$ROOT_DIR/docker-compose.yml" 'aether-load-forecasting-processor'
assert_not_contains "$ROOT_DIR/docker-compose.yml" 'AETHER_LOAD_FORECASTING_'

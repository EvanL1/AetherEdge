...
///
/// Probes the active `StorageBackend` (Null / Postgres / Timescale)
...
/// the backend (TimescaleDB continuous aggregate); history
...
///
/// Returns the active backend kind (Null / Postgres / Timescale),

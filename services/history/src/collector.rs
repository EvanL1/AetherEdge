...
mod tests {
    ...
    async fn config_pool() -> SqlitePool {
        ...
        for statement in [
            ...
            "CREATE TABLE adjustment_points (channel_id INTEGER, point_id INTEGER, min_value REAL, max_value REAL, step REAL)",
            ...
            "INSERT INTO adjustment_points VALUES (10, 4, 0.0, 100.0, 1.0)",

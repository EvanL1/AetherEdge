...
/// # Design Rationale
///
/// Protocol channels are selected from persisted configuration and coexist in
/// one manager. `async_trait` keeps that heterogeneous runtime boundary
/// object-safe for `Box<dyn ChannelRuntime>`.
#[async_trait]
